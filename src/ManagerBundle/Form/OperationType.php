...
//        $builder->get('broker')->addEventListener(
//            FormEvents::POST_SUBMIT,
//            function (FormEvent $event) use ($formMarketModifier) {
//                $broker = $event->getForm()->getData();
//                $formMarketModifier($event->getForm()->getParent(), $broker);
//            }
//        );
//
//        $builder->get('market')->addEventListener(
//            FormEvents::POST_SUBMIT,
//            function (FormEvent $event) use ($formProductModifier) {
//                $market = $event->getForm()->getData();
//                $formProductModifier($event->getForm()->getParent(), $market);
//            }
//        );
    }
